...
using WebCrawler.Scenes.TitleScene;
...
namespace WebCrawler
{
    public class WebCrawlerGame : Game
    {
        ...
        public const string GAME_NAME = "WebCrawler";
        ...
        private static WebCrawlerGame crossPlatformGame;
        ...
        protected override void Initialize()
        {
            ...
            CurrentScene = new MapScene(GameMap.TechWorldIntro, 10, 10, SceneObjects.Maps.Orientation.Down);
        }
        ...
        public void ApplySettings()
        {
            ...
            */
            ...
            compositeRender = new RenderTarget2D(graphicsDeviceManager.GraphicsDevice, ScreenWidth, ScreenHeight);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.Opaque, SamplerState.PointClamp, DepthStencilState.Default, RasterizerState.CullCounterClockwise, shader, Matrix.CreateScale(Scale, Scale, 1));
        ...
        public static WebCrawlerGame GameInstance { get => crossPlatformGame; }
